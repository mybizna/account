...
class Ledger
{
    ...
    public function data(Datasetter $datasetter)
    {
        ...
        $liability_chart_id = DB::table('account_chart_of_account')
        ...
        $equity_chart_id = DB::table('account_chart_of_account')
        ...
        $income_chart_id = DB::table('account_chart_of_account')
            ->where('slug', 'income')->value('id');

        $datasetter->add_data('account', 'ledger',  'slug', [
            "chart_id" =>  $income_chart_id,
            "name" => "Sales",
            "slug" => "sales",
            "code" => "400",
            "system" => "0"
        ...
        $expense_chart_id = DB::table('account_chart_of_account')
            ->where('slug', 'expense')->value('id');

        $datasetter->add_data('account', 'ledger',  'slug', [
            "chart_id" =>  $expense_chart_id,
