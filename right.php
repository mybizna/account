...
$this->add_right("account", "chart_of_account", "manager", view:true, add:true, edit:true, delete:true);
$this->add_right("account", "chart_of_account", "supervisor", view:true, add:true, edit:true, delete:true);
$this->add_right("account", "chart_of_account", "staff", view:true, add:true, edit:true);
$this->add_right("account", "chart_of_account", "registered", view:true, add:true);
$this->add_right("account", "chart_of_account", "guest", view:true, );
...
$this->add_right("account", "coupon", "supervisor", view:true, add:true, edit:true, delete:true);
$this->add_right("account", "coupon", "staff", view:true, add:true, edit:true);
$this->add_right("account", "coupon", "registered", view:true, add:true);
$this->add_right("account", "coupon", "guest", view:true, );
...
$this->add_right("account", "financial_year", "supervisor", view:true, add:true, edit:true, delete:true);
$this->add_right("account", "financial_year", "staff", view:true, add:true, edit:true);
$this->add_right("account", "financial_year", "registered", view:true, add:true);
$this->add_right("account", "financial_year", "guest", view:true, );
...
$this->add_right("account", "gateway", "supervisor", view:true, add:true, edit:true, delete:true);
$this->add_right("account", "gateway", "staff", view:true, add:true, edit:true);
$this->add_right("account", "gateway", "registered", view:true, add:true);
$this->add_right("account", "gateway", "guest", view:true, );
...
$this->add_right("account", "gateway_allowedin", "staff", view:true, add:true, edit:true);
$this->add_right("account", "gateway_allowedin", "registered", view:true, add:true);
$this->add_right("account", "gateway_allowedin", "guest", view:true, );
...
$this->add_right("account", "gateway_disallowedin", "registered", view:true, add:true);
$this->add_right("account", "gateway_disallowedin", "guest", view:true, );
...
$this->add_right("account", "gateway_rate", "registered", view:true, add:true);
$this->add_right("account", "gateway_rate", "guest", view:true, );
...
$this->add_right("account", "invoice_coupon", "guest", view:true, );
...
$this->add_right("account", "invoice_item", "guest", view:true, );
...
$this->add_right("account", "invoice_item_rate", "guest", view:true, );
...
$this->add_right("account", "invoice_status", "guest", view:true, );
...
$this->add_right("account", "journal", "registered", view:true, add:true);
$this->add_right("account", "journal", "guest", view:true, );
...
$this->add_right("account", "ledger", "registered", view:true, add:true);
$this->add_right("account", "ledger", "guest", view:true, );
...
$this->add_right("account", "ledger_category", "staff", view:true, add:true, edit:true);
$this->add_right("account", "ledger_category", "registered", view:true, add:true);
$this->add_right("account", "ledger_category", "guest", view:true, );
...
$this->add_right("account", "opening_balance", "staff", view:true, add:true, edit:true);
$this->add_right("account", "opening_balance", "registered", view:true, add:true);
$this->add_right("account", "opening_balance", "guest", view:true, );
...
$this->add_right("account", "payment", "staff", view:true, add:true, edit:true);
$this->add_right("account", "payment", "registered", view:true, add:true);
$this->add_right("account", "payment", "guest", view:true, );
...
$this->add_right("account", "payment_rate", "registered", view:true, add:true);
$this->add_right("account", "payment_rate", "guest", view:true, );
...
$this->add_right("account", "rate", "registered", view:true, add:true);
$this->add_right("account", "rate", "guest", view:true, );
...
$this->add_right("account", "rate_allowedin", "registered", view:true, add:true);
$this->add_right("account", "rate_allowedin", "guest", view:true, );
...
$this->add_right("account", "rate_disallowedin", "registered", view:true, add:true);
$this->add_right("account", "rate_disallowedin", "guest", view:true, );
...
$this->add_right("account", "rate_file", "registered", view:true, add:true);
$this->add_right("account", "rate_file", "guest", view:true, );
...
$this->add_right("account", "transaction", "registered", view:true, add:true);
$this->add_right("account", "transaction", "guest", view:true, );
